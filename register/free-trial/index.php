	  ...
	  <div class="register-box">
		...
		<div class="register-form">
		  ...
		  <div class="jotform">
			...
			<iframe
			  id="JotFormIFrame-253011927023446"
			  title="Trial Registration"
			  onload="window.parent.scrollTo(0,0)"
			  allowtransparency="true"
			  allow="geolocation; microphone; camera; fullscreen; payment"
			  src="https://form.jotform.com/253011927023446"
			  frameborder="0"
			...
			<script>window.jotformEmbedHandler("iframe[id='JotFormIFrame-253011927023446']", "https://form.jotform.com/")</script>
