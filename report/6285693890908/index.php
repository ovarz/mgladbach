<?php
  ...
  if (!isset($_SESSION['user']) || $_SESSION['user'] !== "6285693890908") {
...
<div class="rancak-foundation">
  ...
  <section class="section-default section-view-report content-center">
    <div class="site-container">
	  ...
	  <div class="svr-embed">
	    <embed type="application/pdf" src="report/6285693890908/u8-u8FOH-Auzan_Alkhawarizmi-dec25.pdf" width="800" height="1132"></embed>
	  </div>
	</div>
  </section>
