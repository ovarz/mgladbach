  ...
  <div class="sidebar">
    <div class="sidebar-container">
      ...
      <div class="sidebar-tab">
        <a title="Front" class="sidebar-tab-button" href="report/">Front</a>
        <a title="Back" class="sidebar-tab-button sidebar-tab-curr" href="report/back.php">Back</a>
      </div>
		...
		<div class="rpf-content">
		  ...
		  <div class="rpf-signature">
		    <div class="rpf-signature-box">
			  <div class="rpf-signature-img"><img src="report/signature.png"/></div>
...
<script src="report/back.js"></script>
</body>
</html>